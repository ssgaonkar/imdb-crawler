...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on('click', '.movie-tile', function (event) {
            ...
            var sourceUrl = 'http://www.imdb.com/video/imdb/' + trailerimdbId+'/imdb/embed?autoplay=true&width=620';
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Movie Mania Trailers</a>
          </div>
        </div>
      </div>
    </div>
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
            ...
            trailer_imdb_id=movie.trailer_yt_url
        )
    return content
...
def open_movies_page(movies):
    ...
    output_file = open('movie_mania.html', 'w')
